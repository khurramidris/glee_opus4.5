...
export function IconSidebar() {
    ...
    return (
        <aside className="w-16 flex flex-col items-center py-4 bg-panel rounded-2xl h-full">
            {/* Top Chat Icon */}
            <NavLink
                to="/characters"
                title="Chat"
                className={({ isActive }) =>
                    cn(
                        'w-10 h-10 flex items-center justify-center rounded-xl transition-all duration-300 mb-3',
                        isActive
