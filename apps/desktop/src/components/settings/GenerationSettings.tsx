...
export function GenerationSettings() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-white mb-2 font-display">Generation Settings</h2>
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm text-white/70">{formData.temperature}</span>
            </div>
            <input
              type="range"
              min="0"
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm text-white/70">{formData.topP}</span>
            </div>
            <input
              type="range"
              min="0"
