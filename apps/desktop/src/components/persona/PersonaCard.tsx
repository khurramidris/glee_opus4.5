...
export const PersonaCard = memo(function PersonaCard({
  ...
  return (
    <Card padding="none" className="overflow-hidden border border-surface-200">
      ...
      <div className="flex border-t border-surface-200 bg-surface-50">
        {!persona.isDefault && (
          <>
            <button
              onClick={onSetDefault}
              className="flex-1 px-4 py-2.5 text-sm text-surface-500 hover:text-surface-900 hover:bg-surface-100 transition-colors"
            >
              Set Default
            </button>
        ...
        <button
          onClick={onDelete}
          className="px-4 py-2.5 text-surface-400 hover:text-red-500 hover:bg-surface-100 transition-colors"
        >
